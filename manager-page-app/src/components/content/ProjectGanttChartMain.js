...
const ProjectGanttChartMain = () => {
    const initialProjects = {
        project1: {
            name: "프로젝트 1",
            data: [
                { id: 1, text: "계획", start_date: "03-07-2024", duration: 5, parent: 0, open: true, progress: 1 },
                { id: 2, text: "문석 파악", start_date: "05-07-2024", duration: 5, parent: 1, progress: 0.6 },
                { id: 3, text: "분석", start_date: "10-07-2024", duration: 7, parent: 0, progress: 0.6 },
                { id: 4, text: "설계", start_date: "17-07-2024", duration: 5, parent: 0, progress: 0.5 },
                { id: 5, text: "개발", start_date: "22-07-2024", duration: 10, parent: 0, progress: 0.3 },
                { id: 6, text: "테스트", start_date: "05-08-2024", duration: 7, parent: 0, open: true, progress: 0.2 },
                { id: 7, text: "Test", start_date: "15-08-2024", duration: 3, parent: 6, progress: 0 },
                { id: 8, text: "배포", start_date: "15-08-2024", duration: 3, parent: 0, open: true, progress: 0 },
                { id: 9, text: "모니터링", start_date: "15-08-2024", duration: 3, parent: 8, progress: 0 },
            ]
        },
        project2: {
            name: "프로젝트 2",
    ...
    const exportToExcel = () => {
        ...
        const data = project.data.map(task => ({
            ID: task.id,
            Task: `${task.parent > 0 ? 'L ' : ''}${task.text}`, 
        ...
        const ganttData = project.data.map(task => {
            ...
            return [task.parent > 0 ? ` L ${task.text}` : task.text, ...row];
        });
